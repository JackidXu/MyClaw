...
When generating images containing Chinese, Japanese, Korean, or any non-Latin text:
...
5. Add `CRITICAL: All text must be clearly legible with zero garbled characters or incorrect text. If text cannot be rendered perfectly, omit it entirely and use visual elements instead.` to EVERY image generation prompt
