...
7. **Ignoring AI Overview** — Use `geo-content-optimizer` skill to compare your content against AI Overview.
...
2. Run `visibility_tester.py` for brand monitoring (requires Perplexity/Kimi API key)
