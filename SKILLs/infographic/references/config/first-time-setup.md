...
options:
  ...
  - label: "craft-handmade / 手工纸艺"
    description: "Hand-drawn, paper craft (general default)"
  - label: "corporate-memphis / 孟菲斯商务"
    description: "Flat vector, vibrant"
  - label: "morandi-journal / 莫兰迪手账"
