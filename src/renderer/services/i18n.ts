...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    libraryMoveToTrash: '移到废纸篓',
    libraryManageSite: '管理网站',
    libraryTrashConfirm: '确定要将这个文件移到系统废纸篓吗？任务不会被删除。',
    ...
    libraryEmptyTitle: '还没有符合条件的资料',
    libraryEmptyDescription: '调整筛选条件后重试；新生成、分享或部署的资料会自动出现在这里。',
    ...
    libraryCloudAvailability_all: '全部状态',
    ...
    sitesSettingsConfirmTitle: '确认保存网站设置？',
    sitesSettingsConfirmDescription: '保存后，网站名称或访问方式的修改将立即生效。',
    sitesConfirmSaveSettings: '确认保存',
  ...
  en: {
    ...
    libraryTrashConfirm: 'Move this file to the system Trash? Related sessions will not be deleted.',
    ...
    libraryEmptyTitle: 'No matching library items',
    libraryEmptyDescription: 'Try changing the filters. Newly created, shared, or deployed items will appear here automatically.',
    ...
    libraryCloudAvailability_all: 'All statuses',
    ...
    sitesSettingsConfirmTitle: 'Save these site settings?',
    sitesSettingsConfirmDescription:
      'Changes to the site name or access settings will take effect immediately.',
    sitesConfirmSaveSettings: 'Save settings',
