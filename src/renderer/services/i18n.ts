...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    general: '通用',
    model: '模型',
    settingsPlanModelIntro: '套餐模型',
    planModelCatalogBuyPlan: '购买套餐',
    planModelCatalogEmpty: '暂无套餐模型',
    planModelCatalogLoadFailed: '套餐模型加载失败',
    planModelCatalogUnnamedModel: '未命名模型',
    planModelCatalogTextModels: '对话模型',
    planModelCatalogImageModels: '图片模型',
    planModelCatalogVideoModels: '视频模型',
    planModelCatalogImageCapability: '图片生成',
    planModelCatalogVideoCapability: '视频生成',
    planModelCatalogSupportsThinking: '支持深度思考',
  ...
  en: {
    ...
    general: 'General',
    model: 'Model',
    settingsPlanModelIntro: 'Plan Models',
    planModelCatalogBuyPlan: 'Buy Plan',
    planModelCatalogEmpty: 'No plan models available',
    planModelCatalogLoadFailed: 'Failed to load plan models',
    planModelCatalogUnnamedModel: 'Unnamed model',
    planModelCatalogTextModels: 'Chat Models',
    planModelCatalogImageModels: 'Image Models',
    planModelCatalogVideoModels: 'Video Models',
    planModelCatalogImageCapability: 'Image Generation',
    planModelCatalogVideoCapability: 'Video Generation',
    planModelCatalogSupportsThinking: 'Supports deep thinking',
