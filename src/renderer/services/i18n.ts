...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    shortcutScopeHint:
      '快捷键仅在 HeyClaw 窗口获得焦点时生效；输入框聚焦时，仅带有 Cmd/Ctrl 修饰键的快捷键会触发。',
    ...
    editProject: '重命名项目',
    deleteProject: '解散项目',
    deleteProjectConfirm: '确定要解散项目「{name}」吗？解散后其中的对话将移出至原专家，不会被删除。',
    projectName: '项目名称',
    projectNamePlaceholder: '请输入项目名称',
    projectNameRequired: '项目名称不能为空',
    removeFromProject: '从项目移出',
    moveToProjectTitle: '移动到项目',
    selectProjectPlaceholder: '选择一个项目...',
    noProjectsYet: '暂无项目，可直接创建新项目',
    projectEmptyTasks: '暂无对话',
    ...
    agentPin: '置顶',
    agentUnpin: '取消置顶',
    agentPinFailed: '更新专家置顶失败',
    agentReorderFailed: '调整专家顺序失败',
    customCreate: '自定义创建',
    choosePreset: '选择预设',
    agentUseTemplate: '使用模板',
    agentTemplateTitle: '专家模板',
    agentTemplateNew: '新建',
    ...
    agentDefaultModel: '专家默认模型',
    agentDefaultWorkingDirectory: '专家默认工作目录',
    agentDefaultWorkingDirectoryHint: '新建会话默认在此目录执行',
    agentModelInvalidHint: '当前模型已不可用，请重新选择',
    agentSystemPromptPlaceholder:
      '定义这个专家的角色、工作方式和回答风格，例如：你是专业的商业增长顾问，擅长拆解定位、输出脚本、制定排期，并保持格式清晰。',
    agentSkills: '技能',
    ...
    presetAgents: '预设专家',
    myCustomAgents: '我创建的专家',
    createNewAgent: '召唤专家',
    addAgent: '添加',
    expertTabTeams: '专家团',
    expertTabExperts: '专家',
    expertSubTabPreset: '内置',
    expertSubTabCustom: '我的',
    noExpertTeams: '暂无专家团',
    agentTabPrompt: '提示词',
    agentTabBasic: '基础信息',
    agentTabSkills: '技能',
    ...
    agentTabIM: 'IM 渠道',
    agentSubagentsTitle: '允许调用的专家',
    agentSubagentsHint: '选中后，当前专家可以把任务交给这些专家协助完成。',
    agentSubagentsEmpty: '暂无其他已启用专家',
    ...
    agentCreateFailed: '创建专家失败',
    agentSaveFailed: '保存专家设置失败',
    agentDeleteFailed: '召回专家失败',
    agentDefaultCannotDelete: '主专家不能召回',
    agentRecall: '召回',
    agentDeleteConfirmTitle: '确认召回专家',
    agentDeleteConfirmMessage: '确定要召回专家「{name}」吗？召回后专家将不在侧边栏显示，任务记录不受影响。',
    agentUnsavedTitle: '未保存的更改',
    agentUnsavedMessage: '离开后，当前专家设置中的修改将丢失。',
    ...
    coworkContextManualCompactFailed: '手动上下文压缩失败',
    ...
    coworkActionCompactContext: '一键压缩上下文',
    coworkActionNewSession: '开启新任务',
    coworkActionRecharge: '立即充值',
    coworkCreditQuotaBannerTitle: '算力余额不足，请及时充值。',
    coworkCreditQuotaBannerDescription: '当前账号算力余额已用尽，充值后可继续使用。',
    coworkCreditQuotaBannerAction: '立即充值',
    ...
    coworkOutputTruncatedNotice: '已达到单次最大输出上限，部分内容未完全生成。',
    continueGenerating: '继续生成',
    continueGeneratingPrompt: '请继续上面的内容接着输出',
    ...
    scheduledTasksFormAgentId: '执行专家',
    scheduledTasksFormAgentIdPlaceholder: '请选择执行专家',
    scheduledTasksFormAgentSelectorHint: '任务将由此专家执行，并使用其人设与记忆',
  ...
  en: {
    ...
    shortcutScopeHint:
      'Shortcuts only run while the HeyClaw window is focused; while a text field is focused, only shortcuts with a Cmd/Ctrl modifier trigger.',
    ...
    deleteProject: 'Disband Project',
    deleteProjectConfirm: 'Are you sure you want to disband project "{name}"? Conversations will be moved back to their original experts and will not be deleted.',
    ...
    noProjectsYet: 'No projects yet, create a new one',
    projectEmptyTasks: 'No conversations',
    ...
    addAgent: 'Add',
    expertTabTeams: 'Teams',
    expertTabExperts: 'Experts',
    expertSubTabPreset: 'Built-in',
    expertSubTabCustom: 'Mine',
    noExpertTeams: 'No expert teams yet',
    ...
    coworkContextManualCompactFailed: 'Manual context compaction failed',
    ...
    coworkActionCompactContext: 'Compact Context',
    coworkActionNewSession: 'New Task',
    coworkActionRecharge: 'Recharge',
    coworkCreditQuotaBannerTitle: 'Insufficient computing balance. Please recharge.',
    coworkCreditQuotaBannerDescription: 'Computing power balance has been used up. Please recharge to continue.',
    coworkCreditQuotaBannerAction: 'Recharge',
    ...
    coworkOutputTruncatedNotice:
      'Maximum single-response output limit reached. Some content may not be fully generated.',
    continueGenerating: 'Continue Generating',
    continueGeneratingPrompt: 'Please continue outputting from where you left off above.',
    ...
    scheduledTasksFormAgentId: 'Expert',
    scheduledTasksFormAgentIdPlaceholder: 'Select an Expert',
    scheduledTasksFormAgentSelectorHint: 'Task will be executed by this expert using their persona and memory',
    ...
    scheduledTasksDetailAgent: 'Expert',
