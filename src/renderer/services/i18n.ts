...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    subagentPanelTitle: '子专家',
    subagentPanelEmpty: '当前会话暂无子专家',
    ...
    skillsDescription: '为您的专家员工提供预封装且可重复的最佳实践与工具',
    skillInstalled: '已安装',
    ...
    // MCP 服务
    mcpServers: 'MCP',
    mcpDescription: '配置和管理 MCP（Model Context Protocol）服务器，为您的专家员工扩展工具能力',
