...
export const BUNDLED_SKILL_DISPLAY_NAMES: Record<string, LocalizedText> = {
  ...
  'xhs-console': { zh: '小红书运营总控', en: 'XHS Console' },
  'xhs-positioning': { zh: '小红书定位', en: 'XHS Positioning' },
  'xhs-topic': { zh: '小红书选题', en: 'XHS Topic' },
  'xhs-writer': { zh: '小红书笔记正文', en: 'XHS Writer' },
  'xhs-title': { zh: '小红书爆款标题', en: 'XHS Title' },
  'xhs-cover': { zh: '小红书封面制作', en: 'XHS Cover' },
  'xhs-html': { zh: '小红书图文排版', en: 'XHS HTML' },
  'xhs-image': { zh: '小红书AI信息图', en: 'XHS Image' },
  'xhs-account-audit': { zh: '小红书账号体检', en: 'XHS Account Audit' },
  'xhs-note-analytics': { zh: '小红书笔记复盘', en: 'XHS Note Analytics' },
  'xhs-branded': { zh: '小红书品牌内容', en: 'XHS Branded' },
